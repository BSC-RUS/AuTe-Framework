...
@AllArgsConstructor
@NoArgsConstructor
@ConfigurationProperties("multipart.filter")
@Component
public class MultipartFilterConfigProperties {
    private boolean convertEnabled = false;
    private boolean  boundaryStaticEnabled = false;
    private int thresholdTmpFileSize = 1048576;
    private int thresholdFilesSize = 52428800;
}
