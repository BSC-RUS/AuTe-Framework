...
public class AbstractMqWorkerTest {
    ...
    public void init() {
        ...
        testWorker = new TestAbstractMqWorker("queue", new MqProperties(), list);
    }
    ...
    class TestAbstractMqWorker extends AbstractMqWorker {
        TestAbstractMqWorker(String queueNameFrom, MqProperties properties, List<MockMessage> mockMappingList) {
            super(queueNameFrom, properties, mockMappingList, null, null);
        }
