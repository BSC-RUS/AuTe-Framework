...
@Component
public class ExpectedRequestAttachBuilder extends AttachBuilder<ExpectedRequestResult> {

	@Autowired
	public ExpectedRequestAttachBuilder(List<AttachExtractor<ExpectedRequestResult>> extractors) {
		super(extractors);
	}
}
